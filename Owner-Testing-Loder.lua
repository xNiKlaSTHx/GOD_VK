--loadstring(game:HttpGet("https://pastebin.com/raw/fa2a9rLz"))()
--loadstring(game:HttpGet("https://raw.githubusercontent.com/xSaigez/MIDNIGHT/main/MIDNIGHT"))()"

------------------------- Blox Fruits BLOX FRUITS blox fruit BLOX FRUIT-------------------------
...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
	...
	local Window = create:Win("C U R S E D . H U B  |  SCRIPT PREMIUM FOR EVERYONE")
	create:Notifile("CURSED HUB | [💀UPDATE 16] Blox Fruits","PROTECT BY xNiKlaSTHx",25)
	...
	page12:Toggle("Tween Chest (Risk)",false,function(t)
		_G.Chest = t
	end)
...
if game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 then
	...
	local Window = create:Win("C U R S E D . H U B  |  SCRIPT PREMIUM FOR EVERYONE")
	create:Notifile("CURSED HUB | [Update 2.5🎃] King Legacy","PROTECT BY xNiKlaSTHx",25)
	local Tap1 = Window:Taps("Auto Farm")
...
------------------------- Project Hero PROJECT HERO projet hero -------------------------

if game.PlaceId == 6085586197 then
	do  local ui =  game:GetService("CoreGui"):FindFirstChild("redui")  if ui then ui:Destroy() end end
	...
	local Window = create:Win("C U R S E D . H U B  |  SCRIPT PREMIUM FOR EVERYONE")
    create:Notifile("CURSED HUB | [🎉RELEASE] Project Hero","PROTECT BY xNiKlaSTHx",25)
	create:Notifile("ประกาศ","ขณะนี้ Script อยู่ระหว่างการพัฒนาไม่ควรนำมาใช้ก่อน (เสี่ยง)",5)
	create:Notifile("ประกาศ","ขณะนี้ Script อยู่ระหว่างการพัฒนาไม่ควรนำมาใช้ก่อน (เสี่ยง)",10)
	create:Notifile("ประกาศ","ขณะนี้ Script อยู่ระหว่างการพัฒนาไม่ควรนำมาใช้ก่อน (เสี่ยง)",15)
	create:Notifile("ประกาศ","ขณะนี้ Script อยู่ระหว่างการพัฒนาไม่ควรนำมาใช้ก่อน (เสี่ยง)",20)
	create:Notifile("ประกาศ","ขณะนี้ Script อยู่ระหว่างการพัฒนาไม่ควรนำมาใช้ก่อน (เสี่ยง)",25)
    ...
    setclipboard("https://discord.gg/tZg6bUZP8P")
